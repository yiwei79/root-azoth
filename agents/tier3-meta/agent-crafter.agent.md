...
posture:
  always_do:
    - Evaluate existing agent definitions before proposing changes
    - Benchmark agent performance before and after modifications
    - Log all agent design decisions in M3
  ask_first:
    - Creating new agent archetypes not in the D7 catalog
