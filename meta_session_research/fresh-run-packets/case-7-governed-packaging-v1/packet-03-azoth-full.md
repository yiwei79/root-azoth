...
- Apply governed final-delivery discipline.
- Treat final delivery as requiring packaging, auditability, verification, and
  explicit disposition of dirty artifacts.
- Governed state changes require human approval and traceable evidence.
- Untracked handoff/closeout artifacts require explicit disposition.
- Scratch notes must not be silently included in delivery.
- Report what native/governed artifacts, approvals, and gates would be required
  if the user wanted to complete the campaign for real.
